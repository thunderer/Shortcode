...
//            array($s, 'x [[aa]] y', array()),
    ...
    {
        $this->assertInstanceOf(\Thunder\Shortcode\Parser\WordpressParser::class, new WordpressParser());
        $this->assertInstanceOf(\Thunder\Shortcode\Parser\RegularParser::class, new RegularParser());
    }
}
